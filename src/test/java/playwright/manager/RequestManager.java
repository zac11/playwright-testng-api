...
public class RequestManager {
    ...
    public APIResponse getPostRequest(String endpoint){
        return apiRequestContext.post(endpoint);
    }

    public APIResponse getPostRequest(String endpoint, RequestOptions options){
    ...
    public void closePlaywrightConnection(){
        playwright.close();
    }
